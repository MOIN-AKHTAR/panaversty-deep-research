"""
This is my deep research agent project with proper handoff tracing
"""
...
set_tracing_disabled(disabled=False)  # CHANGED: Enable tracing
...
def requirement_gathering_prompt(context: RunContextWrapper[ResearchContext], agent: Agent[ResearchContext]) -> str:
    ...
    **RESPONSE FORMAT:**
    ...
    Example:
    Which specific aspect are you interested in? What time frame? What depth of information?
...
def planning_agent_prompt(context: RunContextWrapper[ResearchContext], agent: Agent[ResearchContext]) -> str:
    ...
    **RESPONSE FORMAT:**
    ...
    Example:
    Research plan: ["query1", "query2", "query3"]
...
def research_agent_prompt(context: RunContextWrapper[ResearchContext], agent: Agent[ResearchContext]) -> str:
    ...
    **RESPONSE FORMAT:**
    Provide the final research report with proper structure and citations.
    """
